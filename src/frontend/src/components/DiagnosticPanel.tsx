...
import { ChevronDown, Activity, Database, RefreshCw, Clock } from 'lucide-react';
...
export default function DiagnosticPanel({ data }: DiagnosticPanelProps) {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-[600px] max-w-[90vw] z-50">
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <Card className="border-warning/50 bg-background/95 backdrop-blur-sm shadow-xl">
          <CollapsibleTrigger className="w-full">
            <CardHeader className="cursor-pointer hover:bg-muted/50 transition-colors">
              ...
              <CardDescription className="text-left">
                Request details, cache state, and retry history
              </CardDescription>
            </CardHeader>
          </CollapsibleTrigger>
                ...
                {data.lastRequest && (
                  <div className="space-y-2">
                    ...
                    <div className="bg-muted/50 rounded-md p-3 space-y-1 font-mono text-xs">
                      ...
                      <div><span className="text-muted-foreground">URL:</span> {data.lastRequest.url}</div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-muted/50 rounded-md p-3 space-y-1 font-mono text-xs">
                        ...
                        <div><span className="text-muted-foreground">Body:</span> {data.lastResponse.bodyPreview}</div>
