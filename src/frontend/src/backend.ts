...
export class Backend implements backendInterface {
    ...
    async analyzeTrade(arg0: string, arg1: number, arg2: number, arg3: number, arg4: number): Promise<TradeSetupResult> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeTrade(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTradeById(arg0: bigint): Promise<TradeAnalysis> {
        if (this.processError) {
            try {
    ...
    async getTradeHistory(): Promise<Array<TradeAnalysis>> {
        if (this.processError) {
            try {
